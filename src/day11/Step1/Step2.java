...
import day11.Step1.KioskService;
...
//        System.out.println(orderList);
        ...
        while(true){
            ...
            if( ch == 1 ){
                System.out.print(">>카테고리명을 입력해주세요 : "); String newCateName = scan.next();
                if (KioskService.categoryAdd(newCateName)) {
                ...
                System.out.println(KioskService.showProductList());
            }
//            else if ( ch == 5 ){
//                System.out.print(">>제품번호를 입력해주세요 : "); int addCartCode = scan.nextInt();
//                KioskService.categoryCheck(addCartCode);
//                if (addCartCode
